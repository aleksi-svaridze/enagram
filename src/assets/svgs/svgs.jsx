...
export const CheckIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M21 8L10 19L5 14" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
export const CheckSpellingBlue = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M7.914 4L4.026 13.014" stroke="#132450" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M11.7889 13.014L7.91394 4" stroke="#132450" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M20 7.56201V13" stroke="#132450" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export const DotsMenuIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<path d="M18.5027 12C18.5027 12.2762 18.2788 12.5002 18.0025 12.5002C17.7263 12.5002 17.5023 12.2762 17.5023 12C17.5023 11.7237 17.7263 11.4998 18.0025 11.4998C18.2788 11.4998 18.5027 11.7237 18.5027 12" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12.5002 12C12.5002 12.2762 12.2762 12.5002 12 12.5002C11.7237 12.5002 11.4998 12.2762 11.4998 12C11.4998 11.7237 11.7237 11.4998 12 11.4998C12.2762 11.4998 12.5002 11.7237 12.5002 12" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M6.49773 12C6.49773 12.2762 6.27378 12.5002 5.99752 12.5002C5.72127 12.5002 5.49731 12.2762 5.49731 12C5.49731 11.7237 5.72127 11.4998 5.99752 11.4998C6.27378 11.4998 6.49773 11.7237 6.49773 12" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
    )
}
...
export const LeftRightSideDirectionArrowIcon = ({width, height, fill}) => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 32 32" fill={fill}>
            <path d="M5.33337 16.0001H26.6667" stroke="#323232" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M10.6667 21.3347L5.33337 16.0001L10.6667 10.6654" stroke="#323232" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M21.3307 10.6654L26.6654 16.0001L21.3307 21.3347" stroke="#323232" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
}
...
export const ChevronDownIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
            <g clipPath="url(#clip0_6021_536)">
            <path d="M4.3225 4.66797L7 7.33964L9.6775 4.66797L10.5 5.49047L7 8.99047L3.5 5.49047L4.3225 4.66797Z" fill="#132450" fillOpacity="0.7"/>
            </g>
            <defs>
