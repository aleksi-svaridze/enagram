export const ChevronsLeftIcon = ({width, height, fill}) => {
    return (
...
export const CheckSpelling = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<path d="M4.71899 11.396H11.095" stroke="#132450" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M7.914 4L4.026 13.014" stroke="#132450" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M11.7889 13.014L7.91394 4" stroke="#132450" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M20 7.56201V13" stroke="#132450" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M19.199 8.3491C20.267 9.4171 20.267 11.1481 19.199 12.2151C18.131 13.2831 16.4 13.2831 15.333 12.2151C14.265 11.1471 14.265 9.4161 15.333 8.3491C16.4 7.2811 18.132 7.2811 19.199 8.3491" stroke="#132450" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
<path d="M18 10V11.7778C18 13.428 17.3679 15.0107 16.2426 16.1776C15.1174 17.3444 13.5913 18 12 18C10.4087 18 8.88258 17.3444 7.75736 16.1776C6.63214 15.0107 6 13.428 6 11.7778V10" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
...
export const ChevronRightIcon = () => {
    return (
        ...
        <path d="M3.33337 8H12.6667" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
...
export const AlignCenterIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<path d="M16 16L16 4" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M12 21L12 6" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8 19L8 3" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M4 15L4 8" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M20.0537 15.4297L20.0537 10.4297" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
    )
}
...
<path d="M10.4994 6.99801H17.5023" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M10.4994 10.9997H17.5023" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M10.4994 15.0014H17.5023" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
    )
}
...
export const LeftRightSideDirectionArrowIcon = ({width, height, fill}) => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 32 32" fill={fill}>
            <path d="M5.33337 16.0001H26.6667" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M10.6667 21.3347L5.33337 16.0001L10.6667 10.6654" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M21.3307 10.6654L26.6654 16.0001L21.3307 21.3347" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}
